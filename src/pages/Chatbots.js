...
const Chatbots = () => {
  ...
  const synevaVersions = [
    { id: 'latest', name: 'Latest', details: 'The most current version of SYNEVA.' },
    { id: '17', name: 'v17 - Mini Transformer', details: 'A version exploring transformer concepts.' },
    { id: '15', name: 'v15 - Advanced Hybrid', details: 'Further hybrid model refinements.' },
    { id: '12', name: 'v12 - Neural Network', details: 'Early neural network implementation.' },
    { id: '10', name: 'v10 - Basic Neural', details: 'Introduction of neural concepts.' },
    { id: '7', name: 'v7 - Trie-based', details: 'Trie-based pattern matching.' },
    { id: '5', name: 'v5 - Advanced Patterns', details: 'More complex pattern matching.' },
    { id: '0', name: 'v0 - Initial Concept', details: 'The very first version.' },
  ];
        ...
        <ModelSection>
          <ModelCard>
            <CardHeader>
              ...
              <ModelDescription>
                An evolving HTML/JS chatbot, from pattern matching to neural attempts, focusing on minimal size.
              </ModelDescription>
            </CardHeader>
            <CardBody>
              <ModelDetails>
