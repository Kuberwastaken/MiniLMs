...
import { FaRobot, FaBook, FaGithub, FaCode, FaBrain, FaGraduationCap } from 'react-icons/fa';
      ...
      >
        <BentoGrid>
          <MainBox 
            ...
            gradient="linear-gradient(to right, #3f51b5, #5c6bc0)"
          >
            <BoxTitle>
          ...
          <MediumBox 
            ...
            gradient="linear-gradient(to right, #546e7a, #78909c)"
          >
            <IconWrapper color="#81d4fa">
              <FaGraduationCap />
            </IconWrapper>
          ...
          <SmallBox 
            ...
            gradient="linear-gradient(to right, #455a64, #607d8b)"
          >
            <BoxTitle>
              <FaCode />
            </BoxTitle>
          ...
          <SmallBox 
            ...
            gradient="linear-gradient(to right, #37474f, #546e7a)"
          >
            <BoxTitle>
              <FaBrain />
            </BoxTitle>
